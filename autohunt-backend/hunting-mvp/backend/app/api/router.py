...
from backend.app.api.routes import admin, audit, digest, entities, health, imports, inbox, jobs, logs, manual_run, matches, own_bench, settings, sources, specialists, vacancies
...
api_router.include_router(manual_run.router, prefix="/manual-run", tags=["manual-run"])
