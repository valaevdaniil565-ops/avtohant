...
def _resolve_live_sheet_reference(
    ...
    *,
    ...
    live_resume_url = str(structured.get("resume_url") or row_map.get("resume_url") or identity.get("resume_url") or "").strip() or None
    ...
    item["specialist_live_resume_url"] = live_resume_url
    return item
...
def build_manual_query_entity(text_value: str, *, mode: str, rate_value: int | None = None) -> tuple[dict[str, Any], dict[str, Any] | None]:
